...
function mcImgSlider(sliderOptions) {
	...
	var l = new E,
		...
		qb = function(b) {
			...
			a.a.p = sliderOptions.effectRandom ? -1 : a.a[d] == 1 ? 0 : 1
		},
		fb = function() {
			a = {
				...
				j: sliderOptions.captionOpacity,
				k: sliderOptions.captionEffect == "none" ? 0 : sliderOptions.captionEffect == "fade" ? 1 : 2,
	...
	ub.prototype = {
		c: function() {
			...
			m = Bb(sliderOptions.startSlide, l);
			this.M(a.d);
			var i, j;
			e = [];
			while (r--) {
	...
	var gb = function() {
		var a = T(sliderOptions.sliderId);
	...
	return {
		...
		reload: Kb,
		getElement: function() {
			return T(sliderOptions.sliderId)
		}
	}
}